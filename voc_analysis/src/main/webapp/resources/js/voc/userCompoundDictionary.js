$(function () {
	...
	$('#btnApply').on('click', function(){
		...
		$.ajax({
			type : "POST", 
			url : getContextPath() + "/management/applyUserCompoundDictionary.do",
			dataType: 'json', 
	...
	$('#btnSelectedDelete').on('click', function(){
		...
		if(selectedKeyword.length>0){
			...
			$.ajax({
				type : "POST", 
				url : getContextPath() + "/management/deleteUserCompoundDictionary.do",
				dataType: 'json', 
				data: JSON.stringify(json), 
				contentType: 'application/json;charset=utf-8',
				mimeType: 'application/json',
	...
	$('#btnAdd').on('click', function(){
		...
		if(keyword.length <= 0){
			...
			$.ajax({
				type : "POST", 
				url : getContextPath() + "/management/addUserCompoundKeyword.do",
				dataType: 'json', 
				data: JSON.stringify(json), 
				contentType: 'application/json;charset=utf-8',
				mimeType: 'application/json',
	...
	function fnSearch(){
		...
		$.ajax({
			type : "POST", 
			url : getContextPath() + "/management/selectUserCompoundDictionaryList.do",
			dataType: 'json', 
			data: JSON.stringify(json), 
			contentType: 'application/json;charset=utf-8',
			mimeType: 'application/json',
