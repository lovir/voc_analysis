$(function(){
	...
	$('.btn_rank_search').click(function(){
		...
		$.ajax({
			type : "post",
			url : getContextPath()+"/voekeywordRanking/emotionPercentage.do",
			...
			success : function(data){
				...
				$.ajax({
					type : "post",
					url : getContextPath()+"/voekeywordRanking/emotionList.do",
					data : $("#searchForm").serialize(),
					success : function(data){
		                ...
		                $.ajax({
		        			type : "post",     
		        			url : getContextPath() + "/voekeywordRanking/emotionCategory.do",
		        			data : $("#searchForm").serialize(),
		        			success : function(data) {
		        				/*alert("리포트 완성");*/
