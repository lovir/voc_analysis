$(function(){
	...
	$('.btn_rank_search').click(function(){
		...
		$.ajax({
			type : "post",
			url : getContextPath()+"/voekeywordRanking/regionDt.do",
			data : $("#searchForm").serialize(),
			success : function(data){
				$("#regionStart").html(data);
				fnsearchTotalListFirst('강화군');
			},
  ...
  //초기화 버튼
	...
	$(document).on('click', '.btn_xls', function(){
		$("#searchForm").attr('action', getContextPath() + "/voekeywordRanking/excelVocRegionSearchResult.do").submit();
	});
 ...
 */
	function fnsearchTotalListFirst(val){
		...
		$.ajax({
			type : "post",
			url : getContextPath()+"/voekeywordRanking/vocRegionSearchResult.do",
			data : $("#searchForm").serialize(),
			success : function(data) {
	...
	function fnsearchList(){
		...
		$.ajax({
			type : "post",
			url : getContextPath()+"/voekeywordRanking/vocSearchRegionResultList.do",
			data : $("#searchForm").serialize(),
			success : function(data) {
