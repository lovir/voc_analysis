$(function(){
	...
	$('.btn_rank_search').click(function(){
		...
		$.ajax({
			type : "post",     
			url : getContextPath() + "/voekeywordRanking/fieldReportChart.do",
	...
	$(document).on('click', '.btn_xls', function(){
		$("#searchForm").attr('action', getContextPath() + "/voekeywordRanking/excelVocFieldSearchResult.do").submit();
	});
 ...
 */
	function fnsearchTotalListFirst(val){
		...
		$.ajax({
			type : "post",
			url : getContextPath()+"/voekeywordRanking/vocfieldSearchResult.do",
			data : $("#searchForm").serialize(),
			success : function(data) {
	...
	function fnsearchList(){
		...
		$.ajax({
			type : "post",
			url : getContextPath()+"/voekeywordRanking/vocfieldSearchResultList.do",
			data : $("#searchForm").serialize(),
			success : function(data) {
