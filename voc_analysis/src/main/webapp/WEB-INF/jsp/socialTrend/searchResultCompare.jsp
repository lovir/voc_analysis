...
$(function () {
	 $('#voeTrendAnalysisLine${param.compare}').highcharts({
		chart: {
			zoomType: 'xy'
		},
		title: {
...
<div class="win win_full">
	<div class="win_head clear2">
		<span class="win_tit bg_none">제안트렌드 분석 <c:out value="${param.compare}" /></span>
		<ul class="win_btnset">
	...
	<div class="win_contarealign_c">
		<c:if test="${not empty searchResultChart}">
			<div id="voeTrendAnalysisLine<c:out value="${param.compare}" />" class="graph_in" style="height:400px;">
			</div>
		</c:if>
	</div>
...
<div class="win win_full">
	<div class="win_head clear2">
		<span class="win_tit bg_none">제안트렌드 분석 랭킹 <c:out value="${param.compare}" /></span>
		<ul class="win_btnset">
		<li><a href="#" class="btn_sh" title="접기"></a></li>
		</ul>
	</div>
