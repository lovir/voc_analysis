...
<html xmlns="http://www.w3.org/1999/xhtml" lang="ko">
	<head>
		...
		<!--// header end -->
		<script type="text/javascript" src="<c:url value='/resources/js/voc/socialTrendAnalysisCompare.js'/>"></script>
			...
			$( window ).load(function() {
				...
				$.ajax({
					...
					success : function(response) {
						/////// 비교분석A
						$('#socialChannelListA').html(selectList(response.socialChannelList));	// 소셜 채널
						
						/////// 비교분석B
						$('#socialChannelListB').html(selectList(response.socialChannelList));	// 소셜 채널
					}
				});  
				
				$.ajax({
					type : "POST", 
					url : getContextPath() + "/socialTrend/trendKeywordCompare.do",
					dataType: 'json', 
					contentType: 'application/json;charset=utf-8',
					mimeType: 'application/json',
			...
			<div class="right_area">
				...
				<div class="cont_body" id="cont_body">
					...
					<form id="searchForm" name="searchForm" method="post">	 
						<input type="hidden" name="pageType" value="socialTrendAnalysisCompare"/> 
