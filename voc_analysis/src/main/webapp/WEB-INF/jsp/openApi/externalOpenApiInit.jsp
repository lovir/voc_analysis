...
<html xmlns="http://www.w3.org/1999/xhtml" lang="ko">
	<head>
		...
		<script type="text/javascript" src="<c:url value='/resources/js/voc/externalOpenApi.js'/>"></script>
						...
						<div class="right_area">
							...
							<div class="cont_body" id="cont_body">
								...
								<div class="main_tab clear2">
									<ul>
									<li ><a href="<c:out value='${pageContext.request.contextPath}' />/openApi/openApiInit.do?portal_id=<c:out value='${portal_id}' />&portal_nm=<c:out value='${portal_nm}' />">Open API  제공</a></li>
									<li class="on"><a href="#">외부 Open API</a></li>
									</ul>
								</div>
								<!--// main tab end -->
								...
								<div class="win win_full">
									<div class="win_head clear2">
										<span class="win_tit bg_none">현재 제공되고 있는 외부 Open API</span>
									...
									<div class="win_contarea align_c">
										...
										<div class="p_20">
											<fieldset>
												<legend>외부 Open API를 통해서 저장되는 데이터 건수</legend>
												<table class="tbl_type04 mt_5" summary="현재 제공되고 있는 외부 Open API 목록">
													...
													<thead>
														<tr>
															<th scope="col">No.</th>
															<th scope="col">외부 Open API 목록</th>
															<th scope="col">누적 건수</th>
															<th scope="col">오늘 수집 건수</th>
														</tr>
													</thead>
													<tbody>
														<tr>
															<td>1</td>
															<td class="align_l"><a href="#" class="t_blue modal_btn" id="observe" name="channel_01">서울시 일별 기상 관측 정보</a></td>
															<td><c:out value="${totalObserveAcmSize }"/></td>
															<td><c:out value="${todayObserveSize }"/></td>
														</tr>
														<tr>
															<td>2</td>
															<td class="align_l"><a href="#" class="t_blue modal_btn" id="forecast" name="channel_01">서울시 주간 기상 예측 정보</a></td>
															<td><c:out value="${totalForecastAcmSize }"/></td>
															<td><c:out value="${todayForecastSize }"/></td>
														</tr>
													</tbody>
												</table>
											</fieldset>
								...
								<div class="modal_popup channel_view" id="basic-modal-channel_01">
									<form name="openApiModalForm" id="openApiModalForm" method="post">
										...
										<input type="hidden" id="apiType" name="apiType" value="observe"/>
									</form>
									<div class="win win_full" style="margin-top:0">
										<div class="win_head clear2">
											<span class="win_tit bg_none" id="modal_title" >외부 Open API 일별 현황 보기</span>
										</div>
