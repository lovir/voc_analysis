...
<html xmlns="http://www.w3.org/1999/xhtml" lang="ko">
	<head>
		...
		<!--// header end -->
		<script type="text/javascript" src="<c:url value='/resources/js/voc/relationAnalysisCompare.js'/>"></script>
				...
				$( window ).load(function() {
					...
					$.ajax({
						...
						success : function(response) {
							...
							$('#metroDeptListB').html("<option value=\"all\">전체</option>");
					...
					<div class="right_area">
						...
						<div class="cont_body" id="cont_body">
							<form id="searchForm" name="searchForm" method="post">
								...
								<input type="hidden" name="vocChannel" id="vocChannel"  value="all"/> 	<!-- 선호채널 -->
								<input type="hidden" name="vocRecType" id="vocRecType"  value="all"/> 	<!-- VOC종류 -->
								<input type="hidden" name="metroDept" id="metroDept"  value="all"/>		<!-- 처리부서 -->
								<input type="hidden" name="repLevel" id="repLevel"  value="all"/>		<!-- 만족도 -->
								<input type="hidden" name="vocKind" id="vocKind"  value="all"/>		<!-- 대분류 -->
								<input type="hidden" name="vocPart" id="vocPart"  value="all"/>		<!-- 중분류 -->
								<input type="hidden" name="vocItem" id="vocItem"  value="all"/>		<!-- 소분류 -->
							</form>
							<div class="cont_head">
											...
											<div class="box_blue">
												...
												<ul class="terms_list type05">
													...
													<li class="terms_w_auto3 mt_20">
														<span><label for="vocChannelListA">접수채널</label></span>
														
														<select id="vocChannelListA"></select>
													</li>
													<li class="mt_20">
														<span><label for="repLevelListA">만족도 등급</label></span>
													...
													<li class="mt_20">
														<span><label for="vocRecTypeListA">VOC 종류</label></span>
														
														<select id="vocRecTypeListA"></select>
													</li>
													
													<li class="terms_w_auto2 mt_20">
														<span><label for="vocKindListA">접수종류</label></span>
													...
													<li class="terms_w_auto2 mt_20">
														<span><label for="metroDeptListA">처리주무부서</label></span>
														<select id="metroDeptListA" title="처리주무부서">
										...
										<div class="win_contarea no_head">
											...
											<div class="box_blue">
												...
												<ul class="terms_list type05">
													...
													<li class="terms_w_auto3 mt_20">
														<span><label for="vocChannelListB">접수채널</label></span>
														
														<select id="vocChannelListB"></select>
													</li>	
																								
													<li class="mt_20">
														<span><label for="repLevelListB">만족도 등급</label></span>
													...
													<li class="mt_20">
														<span><label for="vocRecTypeListB">VOC 종류</label></span>
														
														<select id="vocRecTypeListB"></select>
													</li>
													
													<li class="terms_w_auto2 mt_20">
														<span><label for="vocKindListB">접수종류</label></span>
													...
													<li class="terms_w_auto2 mt_20">
														<span><label for="metroDeptListB">처리주무부서</label></span>
														<select id="metroDeptListB" title="처리주무부서">
															<option value="all">전체</option>
														</select>									
													</li>
												</ul>	
