...
<script type="text/javascript" src="<c:url value='/resources/js/voc/userCompoundDictionary.js'/>"></script>
...
function getImgPath(){
	...
	<div class="cont_body">
		...
		<div class="main_tab clear2">
			...
			<li class="on"><a href="#">사용자복합어사전 관리</a></li>
		...
		<div class="win win_full">
			<div class="win_head clear2">
				<span class="win_tit bg_none">사용자 복합어 사전</span>

				<ul class="win_btnset">
				<li><a href="#" class="btn_dic_add" value="7"  title="사전 등록"></a></li>
				<li><a href="#" class="btn_dic_down" value="7"  title="사전 다운로드"></a></li>
					...
					<div class="dic_list">
						...
						<div class="clear2">	
							...
							<span class="float_r">
								...
								<a href="#" id="btnApply" class="btn ssmall b_orange">전체 적용</a><a href="#" id="btnSelectedDelete" class="btn ssmall b_orange">선택 삭제</a>
							</span>
							</fieldset>
						</div>
