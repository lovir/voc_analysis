...
<script type="text/javascript" src="<c:url value='/resources/js/voc/regionSt.js'/>"></script>
...
<script type="text/javascript" src="<c:url value='/resources/js/common.js'/>"></script>
<script type="text/javascript" src="<c:url value='/resources/js/player/common.js'/>"></script>
...
<!--// location end -->
				...
				<div class="cont_body" id="cont_body">
					...
					<div class="cont_head">
						<span class="cont_tit">지역현황분석</span><span class="cont_desc">민원정보를 지역별로 분석할 수 있는 기능을 제공합니다. </span>
					</div>
