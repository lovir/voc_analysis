...
<script type="text/javascript" src="<c:url value='/resources/js/voc/voeEmotionNl.js'/>"></script>
...
<!--// location end -->
				...
				<div class="cont_body" id="cont_body">
					...
					<div class="cont_head">
						<span class="cont_tit"> 감성분석</span><span class="cont_desc">소셜정보를 감성별로 분석할 수 있는 기능을 제공합니다. </span>
					</div>
