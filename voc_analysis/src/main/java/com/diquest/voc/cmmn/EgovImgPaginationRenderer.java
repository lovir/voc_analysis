...
/*		firstPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\">" +
      ...
      */  
        ...
        //처음
        firstPageLabel = "<span class=\"first\"><a href=\"javascript:;\" onclick=\"{0}({1}, this); return false;\">맨 처음</a></span>&#160;";
        
        //이전
        previousPageLabel = "<span class=\"prev\"><a href=\"javascript:;\" onclick=\"{0}({1}, this); return false;\">이전</a></span>&#160;";
        
        //현재
        currentPageLabel = "<span class=\"on\">{0}</span>&#160;";
        
        //그외
        otherPageLabel = "<span><a href=\"javascript:;\" onclick=\"{0}({1}, this); return false;\">{2}</a></span>&#160;";
        
        //다음
        nextPageLabel = "<span class=\"next\"><a href=\"javascript:;\" onclick=\"{0}({1}, this); return false;\">다음</a></span>&#160;";
        
        //마지막
        lastPageLabel = "<span class=\"last\"><a href=\"javascript:;\" onclick=\"{0}({1}, this); return false;\">맨 마지막</a></span>&#160;";
