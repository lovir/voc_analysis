package com.diquest.voc.socialRelationAnalysis.vo;

import java.util.ArrayList;

import com.diquest.voc.management.vo.CommonSelectBoxVo;

public class SocialRelationAnalysisVo extends CommonSelectBoxVo  {
	/** 사용자 아이피  */
	...
	public SocialRelationAnalysisVo setMultiKeyword(SocialRelationAnalysisVo inputVO){
