...
@Controller
public class SocialRelationAnalysisCompareController {
	/** Log Service */
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/socialRelationAnalysis/socialRelationAnalysisCompareInit.do")
	public String relationInformation(Model model, @ModelAttribute("relationAnalysisVo") SocialRelationAnalysisVo relationAnalysisVo, HttpServletRequest request) throws Exception {
		...
		return "/socialRelationAnalysis/socialRelationAnalysisCompare";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/socialRelationAnalysis/compareRadarChart.do")
	public String compareRadarChart(Model model, HttpServletRequest request, @ModelAttribute("relationAnalysisVo") SocialRelationAnalysisVo relationAnalysisVo) throws Exception {
		relationAnalysisVo.setLogin_Id(portal_id);
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/socialRelationAnalysis/compareKeywordTrend.do")
	public String relationKeywordTrend(Model model, @ModelAttribute("relationAnalysisVo") SocialRelationAnalysisVo relationAnalysisVo) throws Exception {
		...
		try {
			String type = "compare";
			LinkedHashMap<String, Integer> resultMap = socialRelationAnalysisService.getRelationKeywordArr(relationAnalysisVo, type); // 연관키워드(상위 10개 키워드 셋팅)
			if (resultMap != null) {
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/socialRelationAnalysis/vocSearchResultCompare.do")
	public String vocSearchResult(Model model, @ModelAttribute("relationAnalysisVo") SocialRelationAnalysisVo relationAnalysisVo) throws Exception {
		...
		return "/socialRelationAnalysis/vocSearchResultCompare";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/socialRelationAnalysis/detailViewCompare.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/socialRelationAnalysis/getAlikeSearchCompare.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/socialRelationAnalysis/excelVocSearchResultCompare.do")
