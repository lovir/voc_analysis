...
@Controller
public class RelationAnalysisCompareController {
	/** Log Service */
	 ...
	 * 
	 * @param model
	 * @return "/relationAnalysis/informationAnalysis"
	 * @exception Exception
	 */
	@RequestMapping(value = "/relationAnalysis/relationAnalysisCompareInit.do")
	public String relationInformation(Model model, @ModelAttribute("relationVo") RelationAnalysisVo relationAnalysisVo, HttpServletRequest request) throws Exception {
		...
		return "/relationAnalysis/relationAnalysisCompare";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/relationAnalysis/compareRadarChart.do")
	public String compareRadarChart(Model model, HttpServletRequest request, @ModelAttribute("relationVo") RelationAnalysisVo relationAnalysisVo) throws Exception {
		relationAnalysisVo.setLogin_Id(portal_id);
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/relationAnalysis/compareKeywordTrend.do")
	public String relationKeywordTrend(Model model, @ModelAttribute("relationVo") RelationAnalysisVo relationAnalysisVo) throws Exception {
		...
		try {
			String type = "compare";
			LinkedHashMap<String, Integer> resultMap = relationAnalysisService.getRelationKeywordArr(relationAnalysisVo, type); // 연관키워드(상위 10개 키워드 셋팅)
			if (resultMap != null) {
	 ...
	 * 
	 * @param model
	 * @return "/relationAnalysis/vocSearchResultCompare";
	 * @exception Exception
	 */
	@RequestMapping(value = "/relationAnalysis/vocSearchResultCompare.do")
	public String vocSearchResult(Model model, @ModelAttribute("relationVo") RelationAnalysisVo relationAnalysisVo) throws Exception {
		...
		try {
			...
			model.addAttribute("type", relationAnalysisVo.getPageType());
		} catch (Exception e) {
			e.printStackTrace();
		}
		return "/relationAnalysis/vocSearchResultCompare";
	 ...
	 * 
	 * @param model
	 * @return "/relationAnalysis/vocSearchResultListCompare";
	 * @exception Exception
	 */
	@RequestMapping(value = "/relationAnalysis/vocSearchResultListCompare.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/relationAnalysis/detailViewCompare.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/relationAnalysis/getAlikeSearchCompare.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/relationAnalysis/repDeptListCompare.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/relationAnalysis/excelVocSearchResultCompare.do")
